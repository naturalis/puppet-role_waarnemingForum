...
<head>';
	...
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/', $cssfix, '.css" />';
	 ...
	 echo '
	<link rel="stylesheet" type="text/css" href="', $settings['theme_url'], '/css/core-wn.css" />';	
...
<div id="mainframe">
	<div class="tborder">
		<div id="header"><div class="floatright" id="info_section">';
		...
		/*echo '
			...
			<div id="user_section">
						<div class="floatright" style="width:50px;">', template_language_select(), '</div>
				<!--<div class="windowbg2 clearfix">-->';*/
				
		echo '
			</ul><!-- /greeting section -->
			<div id="user_section">
						<div class="floatright" style="width:50px;"></div>
				<!--<div class="windowbg2 clearfix">-->';				
...
// If the user is logged in, display stuff like their name, new messages, etc.
	...
	else
	{
	  /*
		echo '
				...
				<form class="" id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
	...
	echo '
			...
			<h1>';
			echo '
			<a href="//waarneming.nl/">';

	if (empty($settings['header_logo_url']))
		echo $context['forum_name_html_safe'];
	else
		echo '
				<img src="', $settings['header_logo_url'], '" alt="', $context['forum_name_html_safe'], '" /></a>
				';
//				<a href="http://www.telmee.nl/"><img src="/smf/Themes/core-wn/images/logo_telmee.jpg" alt="telmee.nl" /></a>
	...
	//een en ander naar boven gehaald
