	...
	<div class="categoryframe tborder clearfix">
		...
		<table cellspacing="1" class="bordercolor boardsframe">';
			...
			<tr>
				...
				<td', !empty($board['children']) ? ' rowspan="1"' : '', ' class="windowbg stats smalltext">
					', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['posts'], ' <br />
					', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '
				</td>
				<td', !empty($board['children']) ? ' rowspan="1"' : '', ' class="windowbg2 smalltext lastpost">';
				...
				if (!empty($board['children']))
				{
					...
					echo '
			<tr>
				<td class="windowbg smalltext largepadding" colspan ="3"><strong>', $txt['parent_boards'], '</strong>: ', implode(', ', $children), '</td>
			</tr>';
				}
			}
			echo '
